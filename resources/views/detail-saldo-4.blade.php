    ...
    <div class="saldo-base">
        <div class="saldo-container">
            ...
            <div class="bank-container flex column">
                ...
                <input type="text">
                <a class="rekening-btn" href="">Verifikasi</a>
            </div>
        </div>

        <div class="saldo-container" style="margin: 0;">
            <div class="flex space-between">
                <div class="black">Rekening Bank Ditemukan</div>
            </div>

            <div class="bank-container flex column">
                <div class="flex">
                    <img src="{{ asset('/storage/bca.png') }}" alt="" class="logo-ditemukan">
                    <div class="flex column align-start" style="margin: 5px 15px;">
                        <div>Jethro Glen</div>
                        <div class="norek-text">1234567890</div>
                    </div>
                </div>
                
                <a class="rekening-btn" href="detail-saldo-5">Hubungkan</a>
            </div>
        </div>
    </div>
@endsection